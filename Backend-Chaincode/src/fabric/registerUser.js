...
exports.register = async function(userName) {
    try {
        ...
        response.msg =  'Successfully registered and enrolled the user ' + userName + ' and imported it into the wallet';
        return response;

    } catch (error) {
        console.error('Failed to register user ' + userName + ': ' + error);
        response.error =  'Failed to register user ' + userName + ': ' + error;
        return response;
        //process.exit(1);
    }
}
